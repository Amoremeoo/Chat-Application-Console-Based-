...
string inputfield(bool &cancelled){
    ...
    while(true){
        ...
        else{t.push_back(ch);cout<<(char)ch;}
    }
    return t;
}
...
string getpassword(){
    ...
    while(true){
        ...
        else if(ch==0||ch==224){getch();continue;}
        else{pw.push_back(ch);cout<<"*";}
    }
    cout<<endl;
    return pw;
}
...
public:
        ...
        try{
            ...
            for(int i=0;i<count;i++){
                ...
                if(n>=4&&parts[1]==currentUser.getUserID()){
                    ...
                    colour(3);
                    cout<<"  ┌──────────────────────────────────┐"<<endl;
                    cout<<"  │ ";colour(11);cout<<"From: "<<senderName;
                    int p=6+(int)senderName.length();
                    for(int j=p;j<34;j++) cout<<" ";
                    colour(3);cout<<"│"<<endl;
                    cout<<"  │ ";colour(8);cout<<parts[2];
                    for(int j=(int)parts[3].length();j<34;j++) cout<<" ";
                    colour(3);cout<<"│"<<endl;
                    cout<<"  │ ";colour(15);cout<<parts[3];
                    int ml=(int)parts[2].length();
                    // wrap long messages
                    if(ml<34){for(int j=ml;j<34;j++) cout<<" ";}
                    colour(3);cout<<"│"<<endl;
                    cout<<"  └──────────────────────────────────┘"<<endl;
                    colour(15);cout<<endl;
                }
        ...
        try{
            ...
            for(int i=0;i<count;i++){
                ...
                if(n>=4&&parts[0]==currentUser.getUserID()){
                    ...
                    colour(3);
                    cout<<"  ┌──────────────────────────────────┐"<<endl;
                    cout<<"  │ ";colour(11);cout<<"To: "<<rname;
                    int p=4+(int)rname.length();
                    for(int j=p;j<34;j++) cout<<" ";
                    colour(3);cout<<"│"<<endl;
                    cout<<"  │ ";colour(8);cout<<parts[2];
                    for(int j=(int)parts[3].length();j<34;j++) cout<<" ";
    ...
    void viewConversation(){
        ...
        colour(3);cout<<"║"<<endl;
        cout<<"  ║ ";colour(8);cout<<otherStatus;
